...
//int MS_TIME_SL;
pthread_t thr; 
extern uint32_t created_req;
extern uint32_t completed_req;
extern uint32_t freed_req;
...
//#endif
	...
	//printf("created: %u, completed: %u, freed: %u\n", created_req, completed_req, freed_req);
	printf("created: %ld, completed: %ld\n", created_req, completed_req);
